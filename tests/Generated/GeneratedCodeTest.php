...
{
    /**
     * The two services of ondewo-survey-api. Survey has no vendored protos: everything this
     * client ships lives under `Ondewo\Survey`.
     *
    ...
    private const EXPECTED_SERVICE_CLIENTS = [
        \Ondewo\Survey\SurveysClient::class,
        \Ondewo\Survey\FHIRClient::class,
    ];
