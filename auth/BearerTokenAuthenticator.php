 ...
 *
 * ```php
 * $client = new \Ondewo\Survey\SurveysClient('survey.ondewo.com:443', [
 *     'credentials'     => \Grpc\ChannelCredentials::createSsl(),
 *     'update_metadata' => new \Ondewo\Survey\Auth\BearerTokenAuthenticator($token),
 * ]);
 * ```
 *
